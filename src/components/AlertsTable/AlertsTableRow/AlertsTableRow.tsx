            ...
            <Col xs={3}>
              <button className='alerts-table__icon'>
                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M7.49933 1L7.49895 13.9983" stroke="#8997DC" stroke-width="2" stroke-linecap="round"/>
                  <path d="M13.9993 7.49805L1.00103 7.49842" stroke="#8997DC" stroke-width="2" stroke-linecap="round"/>
                </svg>
              </button>
              ...
              <button className='alerts-table__icon'>
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clip-path="url(#clip0_3315_2700)">
              ...
              <button className='alerts-table__icon' onClick={() => onDelete(data.id)}>
                <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M9.75592 0.234315C9.59964 0.0842854 9.38768 0 9.16667 0H5.83333C5.61232 0 5.40036 0.0842854 5.24408 0.234315C5.0878 0.384344 5 0.587827 5 0.8C5 1.01217 5.0878 1.21566 5.24408 1.36569C5.40036 1.51571 5.61232 1.6 5.83333 1.6H9.16667C9.38768 1.6 9.59964 1.51571 9.75592 1.36569C9.9122 1.21566 10 1.01217 10 0.8C10 0.587827 9.9122 0.384344 9.75592 0.234315Z" fill="#545D88"/>
