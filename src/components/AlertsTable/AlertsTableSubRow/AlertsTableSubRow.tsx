...
export const AlertsTableSubRow: FC<Props> = ({ data, currentSymbol, counterEarning, marketPrice = 0, isFilled = false, isAdditional = false }) => {
...
export default AlertsTableSubRow;